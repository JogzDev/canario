-- P20 — CATEGORIA NAO E UM ATRIBUTO COMPENSAVEL
--
-- O limiar de 70% aceitava uma regata como similar de uma jaqueta quando cor,
-- estilo e tecido batiam. Categoria define o tipo da peça: quando foi marcada,
-- ela passa a ser obrigatória; o casamento parcial continua valendo nas outras
-- dimensões.
...
comment on function public.similares_da_peca(text[], integer, numeric) is
  'Peças semelhantes por atributos em comum. P20: categoria marcada e obrigatoria; demais dimensoes aceitam casamento parcial.';
