...
as $function$
  ...
  sim as (
    ...
    -- UM lateral so para as duas perguntas. Eram dois, e cada um expandia o
    -- jsonb da grade de novo: 18 mil pecas viravam 36 mil expansoes, e a busca
    -- por "blusa e top" batia em 3,18s contra o limite de 3s do papel `anon`.
    cross join lateral (
