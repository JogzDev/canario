        ...
        if let cor = leitura.cor {
            ...
            if !jaTemCor, let termo = existe {
                ...
                if cor.podeSugerirCor {
                    ...
                    achado.procedencia.append(
                        "The color was left unselected on purpose: this photo's lighting was not reliable enough to measure it. "
                        + "Pick the color below, or retake the photo with color-accurate capture.")
                }
            }
        }
