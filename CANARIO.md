...
- `ADITIVA` | **Cron diário aprovado e ativado**: `0 6 * * *` UTC = 03:00 BRT. Só produz coleta real quando o runner residencial estiver de pé; no datacenter o disjuntor aborta em 429. **[EMENDADO em 21/09/2026: o caminho regular passou a executor gerenciado e o cron a `17 6 * * *` (03:17 BRT), fora do pico documentado do início da hora.]**
