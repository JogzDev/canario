...
- `ADITIVA` | **A17 liberada pelo JP apesar da meta aspiracional.** O piso combinado continua sendo 80%; 20/24 em categoria e 22/24 em cor o abriram. As 300 passam a exigir `vision-foreground-v1`, sem fallback para imagem bruta, e excluem por hash a calibração. O resultado contra pasta de catálogo continua diagnóstico até adjudicação humana.
