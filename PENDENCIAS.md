...
| A15 | OpenAI no runtime: visão + redator com coleira | 🟡 Secret e contrato validados; Luna v5 mediu **20/24 em categoria e 22/24 em cor** contra ouro humano, com 24/24 respostas auditáveis. Visão passou o piso, mas integração, disclosure e redator com coleira continuam pendentes |
| A16 | Interface da v1 em inglês | 🔴 Decidido; tradução e nome definitivo pendentes |
| A17 | Calibrar Luna nas mesmas 24; só então abrir holdout de 300 | 🟡 **Portão técnico aberto no v5:** categoria 20/24 (83,3%), cor 22/24 (91,7%). Como categoria ainda não chegou à meta de produto de 90%, as 300 não foram executadas; quatro casos-limite estão documentados |
...
| NQ16 | **Luna: repetir 24 e integrar visão/redação só depois do portão** | 🟡 v4: 17/24 categoria e cor. v5: **20/24 categoria, 22/24 cor**, prompt hash travado e respostas completas legíveis. Piso atingido; meta de 90% ainda não em categoria | Decidir os quatro limites S10/S18/S20/S21 sem retunar indefinidamente a calibração; só então holdout cego de 300, contrato/privacidade e fallback humano no runtime |
